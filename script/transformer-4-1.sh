...
if [ -f "checkpoints/4-1/${GRAMMAR}/${SPLIT}-transformer/checkpoint_last.pt" ]; then
    TRAIN_CMD="$TRAIN_CMD --restore-file \"checkpoints/4-1/${GRAMMAR}/${SPLIT}-transformer/checkpoint_last.pt\""
fi
