...
if [ -f "checkpoints/8-1/${GRAMMAR}/${SPLIT}-transformer/checkpoint_best.pt" ]; then
    TRAIN_CMD="$TRAIN_CMD --restore-file \"checkpoints/8-1/${GRAMMAR}/${SPLIT}-transformer/checkpoint_best.pt\""
fi
