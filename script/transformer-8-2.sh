...
if [ -f "checkpoints/8-2/${GRAMMAR}/${SPLIT}-transformer/checkpoint_last.pt" ]; then
    TRAIN_CMD="$TRAIN_CMD --restore-file \"checkpoints/8-2/${GRAMMAR}/${SPLIT}-transformer/checkpoint_last.pt\""
fi
